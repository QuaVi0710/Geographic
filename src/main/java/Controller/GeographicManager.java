...
public class GeographicManager extends Menu<String> {
    ...
    public void execute(int choice) {
        switch (choice) {
            case 1 ->
                countryRepository.addCountry(countryList);
            case 2 ->
                countryRepository.displayCountry(countryList);
            case 3 ->
                countryRepository.searchCountry(countryList);
            case 4 ->
                countryRepository.sortCountry(countryList);
            case 5 ->
                System.exit(0);
        }
    }
